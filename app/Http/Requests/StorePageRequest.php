...
Šid,Štimlje,Štrpce',
            'tags'=>'required|array',
            'tags.*' => 'required|string|in:Sandwiches,Foodtruck,Pub,Bakery,Pizza,Deli,Fine dining,Buffet,Bar,Bar and Brewery,Fastfood,Cafeteria,BBQ(Barbecue),Gyros,Breakfast,Lunch,Dinner,Dine-in,Drive-through,Drinks,Kebab,Indian,Fish,Pasta,Italian,International,Mexican,Thai,Chinese,Japanese,French,FrenchFries,Burgers,Chicken,Traditional cuisine,SnackBar,Burek,Mediterranean,Seafood,Crepes,Salads,Desserts,Vegan,Vegetarian',
            'theme'=>'required|string|in:dark,light',
            'fontFamily'=>'required|string|in:font-sans,font-serif,font-mono',
